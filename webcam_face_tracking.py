...
class FaceDetector(BaseObjectDetector):
    def __init__(self,
        ...
        options = ObjectDetectorOptions(
            ...
            score_threshold=0.3,
            max_results=3,
            label_allow_list=['car','truck','motorcycle','bus'],
...
def run():
    ...
    matching_fn_kwargs={'min_iou': 0,
                        'multi_match_min_iou': 0}


    dt = 1/5  # assume 15 fps
    tracker = MultiObjectTracker(dt=dt, model_spec=model_spec,matching_fn_kwargs=matching_fn_kwargs)
    print(tracker)
    numtrack=0
    ...
    while True:
        ...
        #print(detections)
        #devo passare gli oggetti della lista detections al tracker
